...
######################################################################### Buttons & Labels End Q2 #########################################################################
        ...
        def store_inlist(self):
            
            self.student_ans = [self.Entry_1.get().rstrip(), self.Entry_2.get().rstrip(), self.Entry_3.get().rstrip()]
            print(self.student_ans)
        ...
        def append2_list(self):
            ...
            if(bool(check)) == True:
                ...
                answer_status.after(2000,lambda : answer_status.destroy())
